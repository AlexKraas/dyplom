<?php
class MyCompany_TechTalk_Adminhtml_ImageController extends Mage_Adminhtml_Controller_action {
    protected function _initAction(){
        $this->loadLayout()->_setActiveMenu('slider/imagedetail')->_addBreadcrumb(
    ...
    public function newAction(){
        $this->loadLayout();
        $this->_addContent($this->getLayout()->createBlock('slider/adminhtml_image_edit'))->_addLeft($this->getLayout()->createBlock('slider/adminhtml_image_edit_tabs'));
        $this->renderLayout();
    }
    public function saveAction(){
        if ($data = $this->getRequest()->getPost()){
            $model = Mage::getModel('slider/imagedetail');
    ...
    public function massDeleteAction(){
        ...
        if(!is_array($ids)) {
            ...
            try{
                $imageModel = Mage::getModel('slider/imagedetail');
                foreach($ids as $id){
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('slider')->__('Total of %d record(s) were deleted.', count($ids)));
            }catch(Exception $e){
                Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
            }
        }
