<?php
class MyCompany_TechTalk_Block_Adminhtml_Category_Edit_Tabs_Form extends Mage_Adminhtml_Block_Widget_Form{
    ...
    protected function _prepareForm() {
        ...
        $this->setForm($form);
        $fieldset = $form->addFieldset('slider_category', array('legend' => Mage::helper('slider')->__('Caption Information')));
        ...
        $fieldset->addField('slider_title', 'text', array(
            'label' => Mage::helper('slider')->__('Slider Title'),
        ...
        $fieldset->addField('display_all_slide_title', 'select', array(
            'label'     => Mage::helper('slider')->__('Display All Slide Title'),
            'class'     => 'required-entry',
            'required'  => true,
        ...
        $fieldset->addField('display_all_slide_description', 'select', array(
            'label'     => Mage::helper('slider')->__('Display All Slide Description'),
            'class'     => 'required-entry',
            'required'  => true,
        ...
        $fieldset->addField('animation_in', 'select', array(
            'label' => Mage::helper('slider')->__('Animation In'),
            'class' => 'required-entry',
            'required' => true,
            'name' => 'animation_in',
            'values' => Mage::getModel('slider/animationin')->getAnimationInVal(),
            'disabled' => false,
            'readonly' => false,
        ));

        $fieldset->addField('animation_out', 'select', array(
            'label' => Mage::helper('slider')->__('Animation Out'),
            'class' => 'required-entry',
            'required' => true,
            'name' => 'animation_out',
            'values' => Mage::getModel('slider/animationout')->getAnimationOutVal(),
            'disabled' => false,
            'readonly' => false,
        ));

        $fieldset->addField('navigation', 'select', array(
            'label'     => Mage::helper('slider')->__('Navigation'),
            'class'     => 'required-entry',
            'required'  => true,
            'name'      => 'navigation',
            'value'  => '0',
        ...
        $fieldset->addField('navigation_bg_color', 'text', array(
            'label' => Mage::helper('slider')->__('Navigation Bg Color'),
            'class' => 'color',
        ...
        $fieldset->addField('pagination_bg_color', 'text', array(
            'label' => Mage::helper('slider')->__('Pagination Bg Color'),
            'class' => 'color',
        ...
        $fieldset->addField('pagination_bg_hover_color', 'text', array(
            'label' => Mage::helper('slider')->__('Pagination Bg Hover Color'),
            'class' => 'color',
        ...
        $fieldset->addField('auto_play', 'text', array(
            'label' => Mage::helper('slider')->__('Auto Play'),
            'name' => 'auto_play',
