<?php
class MyCompany_TechTalk_Block_Adminhtml_Category_Grid extends Mage_Adminhtml_Block_Widget_Grid{
    ...
    protected function _prepareCollection(){
        $collection = Mage::getModel('slider/imagecategory')->getCollection();
    ...
    protected function _prepareColumns(){
        ...
        $this->addColumn('status', array(
            ...
            'width' => '1px',
            'index' => 'status',
            'renderer' => 'slider/adminhtml_slider_renderer_status',
        ));
